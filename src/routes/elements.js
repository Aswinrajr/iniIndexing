...
export const AbstractConferenceCreate = Loadable(
  lazy(() => import('../pages/dashboard/AbstractConferenceCreate'))
);
export const AbstractJournalCreate = Loadable(
  lazy(() => import('../pages/dashboard/AbstractJournalCreate'))
);
// DASHBOARD: INVOICE
...
export const UserViewPage = Loadable(lazy(() => import('../pages/dashboard/UserViewPage')));
...
export const ConferenceCreatePage = Loadable(
  lazy(() => import('../pages/dashboard/ConferenceCreatePage'))
);
export const ConferenceDetails = Loadable(
  lazy(() => import('../pages/dashboard/ConferenceDetails'))
);
export const ConferenceListPage = Loadable(
  lazy(() => import('../pages/dashboard/ConferenceListPage'))
);
export const ConferenceEditPage = Loadable(
  lazy(() => import('../pages/dashboard/ConferenceEditPage'))
);
export const AbstractJournalEditPage= Loadable(
  lazy(() => import('../pages/dashboard/AbstractJournalEditPage'))
);
export const AbstractConferenceEdit= Loadable(
  lazy(() => import('../pages/dashboard/AbstractConferenceEdit'))
);
export const ThesisEdit= Loadable(
  lazy(() => import('../pages/dashboard/ThesisEdit'))
);
export const IJINEdit= Loadable(
  lazy(() => import('../pages/dashboard/IJINEdit'))
);
export const IJINDetails = Loadable(
  lazy(() => import('../pages/dashboard/IJINDetails'))
);
...
export const ThesisListPage = Loadable(
  lazy(() => import('../pages/dashboard/ThesisListPage'))
);
export const IjinCreatePage = Loadable(
  lazy(() => import('../pages/dashboard/IjinCreatePage'))
);
export const ThesisDetails= Loadable(
  lazy(() => import('../pages/dashboard/ThesisDetails'))
);
export const ThesisCreatePage = Loadable(
  lazy(() => import('../pages/dashboard/ThesisCreatePage'))
);


export const IjinList = Loadable(
  lazy(() => import('../pages/dashboard/IjinList'))
);
export const AbstractjournalList = Loadable(
  lazy(() => import('../pages/dashboard/AbstractjournalList'))
);
export const AbstractConferenceList = Loadable(
  lazy(() => import('../pages/dashboard/AbstractConferenceList'))
);
export const AbstractJournalDetails= Loadable(
  lazy(() => import('../pages/dashboard/AbstractJournalDetails'))
);
export const AbstractConfrenceDetails= Loadable(
  lazy(() => import('../pages/dashboard/AbstractConfrenceDetails'))
);
