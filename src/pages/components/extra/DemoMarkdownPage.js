...
// @mui
import { Box, Card, CardContent, CardHeader, Container, Divider, Stack } from '@mui/material';
// routes
...
<img alt='cover' src='https://res.cloudinary.com/trinhmai/image/upload/v1660897321/_Minimall_mock/_Cover/cover_19.jpg'>
...
![cover](https://res.cloudinary.com/trinhmai/image/upload/v1660897321/_Minimall_mock/_Cover/cover_19.jpg)
...
export default function DemoMarkdownPage() {
  return (
    <>
      <Helmet>
        <title> Extra Components: Markdown | INTERNATIONAL JOURNAL INDEXING</title>
      </Helmet>
